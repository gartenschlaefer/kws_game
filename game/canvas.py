...
from button import StartButton, EndButton, HelpButton
...
class CanvasMainMenu(Canvas):
  ...
  def __init__(self, screen):
    ...
    # buttons
    #buttons = (StartButton(self.canvas_surf, position=(100, 100), scale=(3, 3)), HelpButton(self.canvas_surf, position=(100, 200), scale=(3, 3)), EndButton(self.canvas_surf, position=(100, 300), scale=(3, 3)))
    #buttons = (StartButton(self.canvas_surf, position=(100, 100), scale=(3, 3)), HelpButton(self.canvas_surf, position=(100, 200), scale=(3, 3)), EndButton(self.canvas_surf, position=(100, 300), scale=(3, 3)))

    # add text
    #self.interactables_dict.update({'text':text})

    # update canvas objects
    self.interactables_dict.update({'text': text, 'start_button': StartButton(self.canvas_surf, position=(100, 100), scale=(3, 3)), 'help_button': HelpButton(self.canvas_surf, position=(100, 200), scale=(3, 3)), 'end_button': EndButton(self.canvas_surf, position=(100, 300), scale=(3, 3))})

    # add buttons
    #[self.add_interactable(button) for button in buttons]
