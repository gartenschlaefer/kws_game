...
\begin{figure}[!ht]
  \centering
    ...
    \subfigure[left]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/signal_raw_left0_my}}
    \subfigure[right]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/signal_raw_right0_my}}
    \subfigure[up]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/signal_raw_up0_my}}
    \subfigure[down]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/signal_raw_down0_my}}
    \subfigure[go]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/signal_raw_go0_my}}
