...
\begin{figure}[!ht]
  \centering
    \subfigure[\enquote{left} c1 from D]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/ml_adv_example_label_left_c0_enc}}
    \subfigure[\enquote{left} c1 from G]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/ml_adv_example_label_left_c0_dec}}
    \subfigure[\enquote{left} c2 from D]{\includegraphics[width=0.3\textwidth]{./3_theory/figs/ml_adv_example_label_left_c1_enc}}
    \subfigure[\enquote{left} c2 from G]{\includegraphics[width=0.3\textwidth]{./3_theory/figs/ml_adv_example_label_left_c1_dec}}
...
\begin{figure}[!ht]
  \centering
    \subfigure[\enquote{left} real examples]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/ml_adv_gen_left_real}}
    \subfigure[\enquote{left} fakes from G]{\includegraphics[width=0.45\textwidth]{./3_theory/figs/ml_adv_gen_left_fake}}
