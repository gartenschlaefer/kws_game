...
\begin{figure}[!ht]
  \centering
  \subfigure[mel space]{\includegraphics[width=0.40\textwidth]{./3_theory/figs/signal_mfcc_weights_mel}}
  \quad
  \subfigure[frequency space]{\includegraphics[width=0.40\textwidth]{./3_theory/figs/signal_mfcc_weights_f}}
...
\begin{figure}[!ht]
  \centering
  \subfigure[DCT with continuous color scheme]{\includegraphics[width=0.40\textwidth]{./3_theory/figs/signal_mfcc_dct}}
  \quad
  \subfigure[DCT with diverging color scheme]{\includegraphics[width=0.40\textwidth]{./3_theory/figs/signal_mfcc_dct-div}}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.75\textwidth]{./3_theory/figs/signal_mfcc_left0_mfcc_only.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.75\textwidth]{./3_theory/figs/signal_mfcc_left0_no_order_norm0.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.75\textwidth]{./3_theory/figs/signal_mfcc_left0_norm0.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.75\textwidth]{./3_theory/figs/signal_mfcc_left0_no_order_norm1.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[width=0.75\textwidth]{./3_theory/figs/signal_mfcc_left0_order_norm1.png}
