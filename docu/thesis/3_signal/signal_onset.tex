...
The exact keyword onset is calculated from the obtained MFCCs, as described in \rsec{signal_onset_kw}, and the \SI{500}{\milli\second} long feature vectors are sent to the classification system.