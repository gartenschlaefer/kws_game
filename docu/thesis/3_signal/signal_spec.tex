...
To ensures that small energies are more emphasized it is more appealing to logarithmic scale the value space of the spectrogram, for instance, achieved by the calculation of the decibel scale of the spectrogram $P_{DB} \in \R^{K \times M}$ as follows:
