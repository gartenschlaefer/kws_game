...
The recorded audio files provided in the speech command dataset \cite{Warden2018} and further applied in the experiments in \rsec{exp}, are sampled with a sampling rate of \SI{16}{\kilo\hertz} and usually have a time duration of \SI{1}{\second}, apart from some individual shorter files.
