...
\thesisStateRevised
As described in \rsec{intro} Key Word Spotting (KWS) is the task of classifying speech signals of spoken words to single key words out of a set of key words.
