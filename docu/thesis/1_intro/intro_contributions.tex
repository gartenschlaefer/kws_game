...
From the adversarial training of GAN networks, it was examined on how their obtained weights can contribute in the performance of an equivalent CNN model with same convolutional layer structures.
