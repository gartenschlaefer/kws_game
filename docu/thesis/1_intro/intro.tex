...
This is especially interesting in \emph{wake word} applications, where a single keyword has to be detected over the previously mentioned labels representing either noise or any other possible word that can be spoken by a user.
