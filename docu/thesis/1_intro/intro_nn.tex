...
The energy consumption required to train Deep Neural Networks (DNN) with many parameters on a huge training dataset shall not be ignored, especially in times of climatic change.
