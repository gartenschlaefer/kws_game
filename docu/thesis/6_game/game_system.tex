...
The buffer frames are located prior and posterior to a key word onset and were selected to both 5 frames for the prior and posterior buffer frames in the deployed video game.
