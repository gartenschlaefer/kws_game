...
In the experiments in \rsec{exp_fs}, certain constellations of MFCCs features and enhancements were evaluated.
...
However those models could not reach the high accuracy achievements obtained by the sophisticated benchmark models listed in \rsec{prev_kws_benchmark}.
