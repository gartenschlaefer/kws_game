...
Even though \cite{Zhang2017} and \cite{Peter2020} already provide excellent solutions to this problem, it is desirable to further elaborate on it and derive a minimal model so that each layer can be analyzed and comprehended by the researchers.
