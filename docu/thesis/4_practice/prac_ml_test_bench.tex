...
The examples from the adversarial training section are shown in \rfig{ml_test_bench_shift_fc3}.
\begin{figure}[!ht]
  \centering
    \subfigure[adv init]{\includegraphics[width=0.45\textwidth]{./4_practice/figs/ml_test_bench_shift_fc3_adv}}
    \subfigure[random init]{\includegraphics[width=0.45\textwidth]{./4_practice/figs/ml_test_bench_shift_fc3_random}}
...
in \rfig{ml_test_bench_noise_fc3} is the noise invariance from the example in the adversarial training section.

\begin{figure}[!ht]
  \centering
    \subfigure[adv init]{\includegraphics[width=0.40\textwidth]{./4_practice/figs/ml_test_bench_noise_fc3_adv}}
    \subfigure[random init]{\includegraphics[width=0.40\textwidth]{./4_practice/figs/ml_test_bench_noise_fc3_random}}
