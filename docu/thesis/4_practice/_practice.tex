...
% dataset
\input{4_practice/a_dataset.tex}
\input{4_practice/a1_speech_cmd.tex}
\input{4_practice/a2_my.tex}

% machine learning
\input{4_practice/b_ml_practice.tex}
\input{4_practice/b0_ml_details.tex}
\input{4_practice/b1_feature_selection.tex}
\input{4_practice/b2_adversarial.tex}

% game design
\input{4_practice/c_game.tex}
