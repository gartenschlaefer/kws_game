...
Two neural network architectures were chosen from this paper, one is a traditional CNN network and the other is a limited multipliers network with a CNN striding only in the frequency axis.
...
Another highly optimized resource efficient Deep Neural Network (DNN) based on CNNs and obtained with a Neural Architecture Search (NAS) is described by \cite{Peter2020}.
