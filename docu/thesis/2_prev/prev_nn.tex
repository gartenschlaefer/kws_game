...
GANs \cite{Goodfellow2014GANs} were introduced by Goodfellow et al. and were initially motivated from \enquote{Game Theory} regarding a two player zero-sum game with the Min-Max-Theorem as solution concept \cite{VonNeumann1944}.
