...
GANs \cite{Goodfellow2014} were introduced by Goodfellow et al. and were initially motivated from \enquote{Game Theory} regarding a two player zero-sum game with the Min-Max-Theorem as solution concept \cite{VonNeumann1944}.
...
In \cite{Oezdenizci2020} it is shown how an adversarial network improves the generalization of subject specific samples from Electroencephalogram (EEG) data.
