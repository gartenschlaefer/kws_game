...
The experiments fixes the amount of cepstral coefficients to 12 and enhances those with deltas, double deltas, and energy vectors, as described in \rsec{signal_mfcc_enhancement}.
