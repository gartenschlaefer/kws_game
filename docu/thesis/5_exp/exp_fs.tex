...
The experiments fixes the amount of cepstral coefficients (c) to 12 and enhances those with deltas (d), double deltas (dd), and energy vectors (e), as described in \rsec{signal_mfcc_enhancement}.
