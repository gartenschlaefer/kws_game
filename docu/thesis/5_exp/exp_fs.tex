...
Those were used to examine the accuracy on the validation set during training, which is shown in \rfig{exp_fs_mfcc_tb_acc_conv-jim}.
The noise and shift invariance are provided in \rfig{exp_fs_mfcc_tb_noise_conv-jim} and \rfig{exp_fs_mfcc_tb_shift_conv-jim}, respectively.
\begin{figure}[!ht]
  \centering
