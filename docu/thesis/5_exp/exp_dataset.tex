...
The dataset is feature extracted with specified parameters and stored as separate files, so that the feature extraction must not be applied each time a training of the neural networks is performed.
