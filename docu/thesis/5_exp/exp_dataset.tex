...
All available speech command keywords with their separation into training, test, and validation set, are shown in \rtab{exp_dataset_all_labels} located in the appendix.
