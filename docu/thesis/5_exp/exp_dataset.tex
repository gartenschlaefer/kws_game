...
%However some clean up of the dataset was still done as described in...
...
All labels with their separation in training, test and validation set are shown in \rtab{exp_dataset_all_labels}.
