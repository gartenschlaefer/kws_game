...
To examine the recorded examples, one example per label from the speech command dataset in raw audio format is shown in \rfig{exp_dataset_wav_grid_speech_commands_v2}.
\begin{figure}[!ht]
  \centering
