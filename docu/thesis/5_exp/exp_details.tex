...
This gives a maximum amount of 3500 examples per label to represent the whole dataset, because the number of examples per label should not be chosen to higher values than 3500 for training, otherwise the same amount of examples per label is not provided.
...
Therefore they are not a reliable measure for the trained models, but it is interesting to observe how different models perform upon these tests.
