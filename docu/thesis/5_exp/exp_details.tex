...
The deployed video game in \rsec{game} uses only 7 of those L12 labels, the rest is handled equally as the \enquote{\_mixed} label.

The maximal number of examples per label for training is given by the minimum examples per selected label for each label and each set.
...
The L12 labels and their number of examples per label used for training, is listed in \rtab{exp_details_params_dataset}.
...
The hyperparameters for the training of the used CNNs models, described in \rsec{nn_arch}, are shown in \rtab{exp_details_params_train}.
...
\begin{figure}[!ht]
  \centering
    \subfigure[frame shift 0]{\includegraphics[width=0.45\textwidth]{./5_exp/figs/exp_details_tb_shift_left_frame0.png}}
    \subfigure[frame shift 30]{\includegraphics[width=0.45\textwidth]{./5_exp/figs/exp_details_tb_shift_left_frame30.png}}
    \subfigure[frame shift 59]{\includegraphics[width=0.45\textwidth]{./5_exp/figs/exp_details_tb_shift_left_frame59.png}}
...
\begin{figure}[!ht]
  \centering
    \subfigure[\SI{16}{\dB}]{\includegraphics[width=0.45\textwidth]{./5_exp/figs/exp_details_tb_noise_left_snr16.png}}
    \subfigure[\SI{0}{\dB}]{\includegraphics[width=0.45\textwidth]{./5_exp/figs/exp_details_tb_noise_left_snr0.png}}
    \subfigure[\SI{-16}{\dB}]{\includegraphics[width=0.45\textwidth]{./5_exp/figs/exp_details_tb_noise_left_snr-16.png}}
