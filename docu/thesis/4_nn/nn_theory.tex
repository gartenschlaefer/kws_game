...
The most famous activation function nowadays is the Rectified Linear Unit (ReLU) \cite{Zeiler2013} function:
...
\thesisStateNew
Generative Adversarial Neural Networks (GAN) \cite{Goodfellow2014}, as already mentioned in \rsec{prev_nn_adv}, uses two networks: a Generator (G) network for generating fake images and a Discriminator (D) network for discriminating between fake and real images.
