...
\FloatBarrier
\noindent
The amount of training epochs is important, because it determine how much the models learn during their adversarial training.
With 100 epochs the Generator creates similar convolutional filters for each label train instance, because it does not need to be that accurate in creating different looking fakes.
