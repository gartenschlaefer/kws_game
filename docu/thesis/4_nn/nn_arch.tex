...
\begin{itemize}
	...
	\item \texttt{conv-fstride}: from \cite{Sainath2015} (fstride4), striding only in vertical dimension.
	\item \texttt{conv-jim}: self designed model, striding only in horizontal dimension.
\end{itemize}
