...
In contrast to CNNs, Wavenets are using raw audio samples as input features.
When deployed in an online system, the Wavenet architecture has no need to extract MFCC features.
However, it will be shown that the overall computations are not reduced because of the complexity of Wavenets.
