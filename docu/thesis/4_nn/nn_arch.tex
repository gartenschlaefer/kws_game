...
Assuming that the input will be of shape $d_x = (1 \times 12 \times 50)$, following dimensions, amount of parameters and operations or each layer, listed in \rtab{nn_arch_cnn_trad}, are present.
